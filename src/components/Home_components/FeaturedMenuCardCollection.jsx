...
const FeaturedMenuCardCollection = () => {
    return (
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-10 mb-10 md:mb-20">
            ...
            <FeaturedMenuCard Title="Cheeseburger French fries" image={Cheeseburger_Frenchfries} image_alt="Cheeseburger with French fries and a Drink image" Price="55,000"/>
