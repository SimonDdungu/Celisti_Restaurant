            ...
            <div className="container mx-auto md:min-h-screen md:w-screen flex flex-col md:flex-row justify-between items-center gap-10 pt-32 pb-10 md:pt-39 px-5 md:px-20" >
                ...
                <div>
                    ...
                    <div className="flex items-center gap-3 md:gap-5">
                        <a href="#" className="rounded-full bg-[#153B44] px-5 md:px-7 py-3 md:py-4 text-white hover:bg-(--dark-green) transition-all ease-in-out">Make a Reservation</a>
                        <a href="#" className="rounded-full bg-white border-3 border-(--lime-green) px-5 md:px-7 py-3 md:py-4 hover:bg-black hover:text-white hover:border-black transition-all ease-in-out">Our Menu</a>
                    </div>
                </div>
