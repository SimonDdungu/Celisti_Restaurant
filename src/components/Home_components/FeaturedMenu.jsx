    ...
    return (
        <section>
            <div className="container mx-auto py-10 px-5 md:px-20 md:py-20">
                ...
                <Link to ="/menu" className="block w-max mx-auto rounded-full bg-[#153B44] px-5 md:px-7 py-3 md:py-4 text-white hover:bg-(--dark-green) transition-all ease-in-out">Explore Full Menu</Link>
            </div>
        </section>
    );
};
