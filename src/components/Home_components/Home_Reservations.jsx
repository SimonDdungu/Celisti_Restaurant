    ...
    return (
        ...
        <div className="container mx-auto flex flex-col-reverse md:flex-row justify-between gap-5 py-20 px-5 md:px-20 ">
            ...
            <div>
                ...
                <a href="#" className="block w-max mx-auto rounded-full bg-[#153B44] px-5 md:px-7 py-3 md:py-4 text-white hover:bg-(--dark-green) transition-all ease-in-out">Book a Table</a>
            </div>
        </div>
